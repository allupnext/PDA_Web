...
namespace PDA_Web.Controllers
{
    public class PDAController : Controller
    {
        ...
        public async Task<IActionResult> PDAEstimatorEmail(int id)
        {
            ...
            {
                var custdata = unitOfWork.CustomerUserMaster.GetByIdAsync(Convert.ToInt32(custid));
                if (custdata != null)
                {
                    string Content = "<html> <body>   <p>Hello, <br> Thank you for use our PDA Portal and successful generated PDA. We have attched you generated PDA. PFA. </p> <div> </br> <p> <b> PDA Generated By Name :</b> " + custdata.Result.FirstName  + " "+ custdata.Result.LastName + " </br> <b> Email: </b> " + custdata.Result.Email +"  </p> </div> </body> </html> ";
                    string Subject = "PDA Generation Successfull";
                    List<string> ccrecipients = new List<string>();

                    List<string> recipients = new List<string>
                    {
                        custdata.Result.Email
                    };
                    string FromCompany = "";
                    string ToEmail = "";
