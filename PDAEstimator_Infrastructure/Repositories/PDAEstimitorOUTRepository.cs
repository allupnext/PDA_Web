...
namespace PDAEstimator_Infrastructure.Repositories
{
    public class PDAEstimitorOUTRepository : IPDAEstimitorOUTRepository
    {
        ...
        public async Task<string> AddAsync(PDAEstimatorOutPut entity)
        {
            try
            {
                var sql = "INSERT INTO PDAEstimatorOutPut (PDAEstimatorID ,PDAEstimatorOutPutDate,CompanyName,CompanyLogo,CompanyAddress1,CompanyAddress2,CompanyTelephone,CompanyAlterTel,CompanyEmail,NameofBeneficiary,BeneficiaryAddress,AccountNo,Beneficiary_Bank_Name,Beneficiary_Bank_Address,Beneficiary_RTGS_NEFT_IFSC_Code,Beneficiary_Bank_Swift_Code,Intermediary_Bank,Intermediary_Bank_Swift_Code,BaseCurrencyCode,DefaultCurrencyCode,Taxrate, BaseCurrencyCodeID, DefaultCurrencyCodeID) VALUES (@PDAEstimatorID,@PDAEstimatorOutPutDate,@CompanyName,@CompanyLogo,@CompanyAddress1,@CompanyAddress2,@CompanyTelephone,@CompanyAlterTel,@CompanyEmail,@NameofBeneficiary,@BeneficiaryAddress,@AccountNo,@Beneficiary_Bank_Name,@Beneficiary_Bank_Address,@Beneficiary_RTGS_NEFT_IFSC_Code,@Beneficiary_Bank_Swift_Code,@Intermediary_Bank,@Intermediary_Bank_Swift_Code,@BaseCurrencyCode,@DefaultCurrencyCode,@Taxrate, @BaseCurrencyCodeID, @DefaultCurrencyCodeID) SELECT CAST(SCOPE_IDENTITY() as bigint)";
